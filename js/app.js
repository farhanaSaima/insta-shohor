...
//     toggleicon = true
//     let html = `<i  class="fa-solid fa-heart text-dark"></i>`
//     document.getElementById("love-icon").innerHTML = html
...
//   document.getElementById("love-icon").addEventListener("click", function () {
//     toggleicon = false
//     let html = `<i  class="fa-solid fa-heart text-danger"></i>`
//     document.getElementById("love-icon").innerHTML = html
...
// }
document.getElementById("love-icon").addEventListener("click", function () {
  document.getElementById("love-icon").classList.toggle("text-dark")
})
